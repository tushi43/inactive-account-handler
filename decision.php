...
$query = "SELECT * FROM t2 WHERE username = '$username' AND hashcode = '$password' ";
...
echo "<script type='text/javascript'>alert('Enter Correct username and password from email ');</script>";
...
echo "<script type='text/javascript'>alert('Please Enter the correct details from email sent!');</script>";
	...
	<ul><img src="img/logo.jpg" height="100" width="100" align="left"></ul> 
        ...
        <div class="container">
           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
            ...
            <div class="loginform">
            <form class="form-horizontal" action ="decision.php" method = "POST" onsubmit="return validateform();">
                <fieldset>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login via Email credentials</h3>
                            		<p>Enter your username and Hashcode to log in:</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                   ...
			                   <div class="form-group">
			                    ...
			                    <div class="form-group">
								HASHCODE :<br>
								<label class="sr-only" for="form-password">HASHCODE:</label>
